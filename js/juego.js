...
var instrucciones = ["Utilizá las flechas del teclado para mover la pieza vacía del rompecabezas.", "Mové las piezas hasta formar el manto sagrado."];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  var posTemporal = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = posTemporal;
}
